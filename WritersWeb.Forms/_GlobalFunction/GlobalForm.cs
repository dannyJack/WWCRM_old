...
namespace WritersWeb.Func
{
    public class GForm
    {
        ...
        public static frmAddLead FrmSubLeadAdd { get { return (forms.ContainsKey("frmAddLead") ? forms["frmAddLead"] as frmAddLead : FrmSubLeadAdd = new frmAddLead()); } set { forms[value.Name] = value; } }
